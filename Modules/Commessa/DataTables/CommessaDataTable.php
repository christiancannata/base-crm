...
namespace Modules\Commessa\DataTables;
...
class CommessaDataTable extends BaseDataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (Commessa $workplace) {
                $route = 'commessa';
     ...
     */
    public function query(Commessa $model): QueryBuilder
    {
